...
```yaml
AWSTemplateFormatVersion: '2010-09-09'
Description: EC2 Instance with DynamoDB access and browser-based SSH connection support
...
Parameters:
  ...
  SubnetId:
    ...
    Description: Select a public subnet in your VPC
...
Resources:
  EC2SecurityGroup:
    Type: AWS::EC2::SecurityGroup
    Properties:
      GroupDescription: Allow SSH for EC2 Instance Connect
      VpcId: !Ref VpcId
      SecurityGroupIngress:
        - IpProtocol: tcp
          FromPort: 22
...
Outputs:
  ...
  EC2PublicDNS:
    Description: Public DNS of the instance (for browser connect test)
...
dynamodb = boto3.resource('dynamodb', region_name='eu-west-3') # Region is important !
